...
<p align="center">CocoIndex 将代码库、会议记录、收件箱、Slack、PDF 和视频转化为实时且持续更新的上下文，供你的 AI Agent 和 LLM 应用高效推理使用——仅需极少的增量处理。只需 10 分钟即可为你的生产环境 AI Agent 准备好可靠、持续更新的数据——告别陈旧批次，消除上下文断层。</p>
<p align="center">
  <b>增量处理（Incremental）</b> · 仅处理变更数据 &nbsp;·&nbsp; <b>任意规模（Any scale）</b> · 默认并行 &nbsp;·&nbsp; <b>声明式（Declarative）</b> · Python，5分钟
</p>
...
<h2 align="center">基于 CocoIndex 构建的项目 ❤️</h2>
...
<p align="center"><a href="examples"><b>查看所有 20+ 示例 · 每周更新 →</b></a></p>

<br/>

<h3 align="center">快速开始</h3>

```sh
pip install -U cocoindex
```

声明目标中应包含的*内容*——CocoIndex 将永久保持同步，仅重新计算增量（Δ）。
...
<p align="center">首次运行进行数据回填。随时可再次运行——仅对变更文件重新生成嵌入向量。</p>

<p align="center">
  正在使用 AI 编程 Agent 进行开发？<br/>
  只需引入我们的 <a href="skills/cocoindex/"><b>CocoIndex Skill（技能）</b></a>，即可让你的 Agent 编写出正确的 v1 代码——概念、API、模式均整合在同一文件中。<br/>
  <sub>安装步骤请参阅 <a href="https://cocoindex.io/docs/getting_started/ai_coding_agents/">与 AI 编程 Agent 配合使用</a>。</sub>
</p>
...
<h2 align="center">响应式（Reactive）——<em>专为数据工程设计</em></h2>
...
<p align="center"><a href="https://cocoindex.io/react-cocoindex"><b>查看响应式 ↔ CocoIndex 架构思维模型 →</b></a></p>


<br/><br/>

<h2 align="center">面向长生命周期 Agent 的<em>增量引擎</em></h2>

<p align="center">
  为工程师打造的数据转换工具，专为 AI 负载设计——<br/>
  搭载智能增量引擎，确保数据<em>永远新鲜、可解释。</em>
</p>
...
<h2 align="center">为何选择<em>增量处理？</em></h2>

<p align="center">你的 AI Agent 表现如何，取决于它看到的数据。<br/>传统批处理管道容易过时。CocoIndex 保持实时运行——且仅执行增量（Δ）计算。</p>
...
<h2 align="center">你可以用 CocoIndex <em>构建什么？</em></h2>

<p align="center"><a href="examples" title="Browse all 20+ CocoIndex examples on GitHub — code, PDF, HN, knowledge graph, podcast, CSV-to-Kafka, image, and more"><b>查看所有 20+ 示例 · 每周更新 →</b></a></p>

<p align="center"><b>来自 <a href="examples">示例仓库</a> 的可运行 starter 项目——克隆代码，接入你的数据源，即可快速上线。</b></p>
...
<p align="center">正在使用 CocoIndex 构建项目？ <b>我们很想看看。</b><br/>在 X (Twitter) 上 <a href="https://x.com/cocoindex_io" title="Tag @cocoindex_io on X to showcase your CocoIndex project">@cocoindex_io</a>，或在 Discord 的 <a href="https://discord.com/invite/zpA9S2DR7s" title="Share your project in the CocoIndex Discord #showcase channel">#showcase</a> 频道分享链接。我们会为你推广展示。🥥</p>
...
<p align="center">
  <b>我们<em>非常期待</em>与你相遇。</b><br/>
  每一个错别字修正、新连接器开发、文档优化或全面重构，都会让 CocoIndex 变得更好。<br/>
  欢迎加入——无论是大型还是小型 PR，我们都热烈欢迎。
</p>

<p align="center">
  📝 <a href="https://cocoindex.io/docs/contributing/guide"><b>阅读贡献指南</b></a> &nbsp;·&nbsp;
  🐛 <a href="https://github.com/cocoindex-io/cocoindex/labels/good%20first%20issue"><b>适合新手的 Issue</b></a> &nbsp;·&nbsp;
...
<h3 align="center">大规模语料库 ——<em>专为企事业规模打造。</em></h3>

<p align="center">
  增量计算是让大型语料库保持更新而无需每轮重新生成嵌入的唯一方式。<br/>
  CocoIndex 支持从单个仓库到 PB 级存储的扩展——默认并行，设计即为仅处理增量。
</p>

<br/>

<h3 align="center">一次处理。<em>永久同步。</em></h3>

<p align="center">
  当数据源发生变更时，CocoIndex 会精准识别受影响的记录，将变更传播<br/>
  至关联查询中，更新目标存储并清理过时行——<br/>
  绝不触碰任何未变动的内容。
</p>

<br/>

<h3 align="center">基于 <em>Rust 引擎</em>构建。</h3>

<p align="center">
  核心采用 Rust —— 从第一天起就具备生产级标准。<br/>
  支持并行分块、尽可能实现零拷贝转换，以及故障隔离机制——<br/>
  确保单条异常记录不会阻塞整个数据流。
</p>
...
<p align="center"><sub>Apache 2.0 · © CocoIndex 贡献者 🥥</sub></p>