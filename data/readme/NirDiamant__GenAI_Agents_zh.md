...
> 🌟 **支持本项目：** 你的赞助将推动 GenAI Agent 开发的创新。 **[成为赞助商](https://github.com/sponsors/NirDiamant)**，帮助维护并扩展这一宝贵资源！

# GenAI Agents：开发与实现综合仓库 🚀

欢迎来到当今最全面、最具活力的生成式 AI（GenAI）Agent 教程与实现集合之一。本仓库是学习、构建和分享 GenAI Agent 的综合资源库，涵盖从简单的对话机器人到复杂的多 Agent 系统。
...
**[RAG Made Simple](https://europe-west1-rag-techniques-views-tracker.cloudfunctions.net/rag-techniques-tracker?notebook=genai-agents--readme&click=book-buy-amazon-title&target=https%3A%2F%2Fwww.amazon.com%2Fdp%2FB0D76734SZ%3Ftag%3Ddiamantai-genai-20&text=RAG%20Made%20Simple)** - RAG 系统的生产级参考指南
书中详细讲解了 22 种技术，辅以直觉理解、对比分析和图表。对于需要检索并基于真实数据 grounding（锚定）回复的 Agent 构建者而言，这是必读书籍。
*已售出 1,500+ 册 · 发布当日登顶 Amazon 生成式 AI 畅销榜 · ⭐ 4.4 星*
**Kindle $9.99 · 平装版 $24.99 · Kindle Unlimited 免费阅读**

👉 [**在 Amazon 获取 RAG Made Simple**](https://europe-west1-rag-techniques-views-tracker.cloudfunctions.net/rag-techniques-tracker?notebook=genai-agents--readme&click=book-buy-amazon-cta&target=https%3A%2F%2Fwww.amazon.com%2Fdp%2FB0D76734SZ%3Ftag%3Ddiamantai-genai-20&text=Get%20Made%20Simple)

---

**[Prompt Engineering: Master the Art of AI Interaction](https://europe-west1-rag-technices-views-tracker.cloudfunctions.net/rag-techniques-tracker?notebook=genai-agents--readme&click=book-buy-pe&target=https%3A%2F%2Fwww.amazon.com%2Fdp%2FB0DZ85RPB5%3Ftag%3Ddiamantai-genai-20&text=Prompt%20Engineering)** - 提示工程基础
包含 22 种实操性 Prompting 技术。是 RAG Made Simple 的配套书籍，决定了你的 Agent 表现如何的关键层。

👉 [**在 Amazon 查看 Prompt Engineering**](https://europe-west1-rag-techniques-views-tracker.cloudfunctions.net/rag-techniques-tracker?notebook=genai-agents--readme&click=book-buy-pe-cta&target=https%3A%2F%2Fwww.amazon.com%2Fdp%2FB0DZ85RPB5%3Ftag%3Ddiamantai-genai-20&text=See%20Prompt%20Engineering)
...
> **近期新增：** HR AI Assistant、LightRAG 艺术导览、上下文报价系统、ML/DS Assistant、Gutenberg Sage | **52 个教程**并持续更新中
...
<table>
<tr>
<td align="center">🚀<br><b>前沿<br>动态</b></td>
<td align="center">💡<br><b>专家<br>见解</b></td>
<td align="center">🎯<br><b>前 0.1%<br>优质内容</b></td>
</tr>
</table>
...
*加入超过 50,000 名 AI 爱好者的行列，获取独家前沿见解与免费教程！***订阅者还可提前获得专属内容，并享受本人书籍及即将推出的 RAG Techniques 课程 33% 的特别折扣！***
</div>
...
生成式 AI Agent 处于人工智能技术的最前沿，正在彻底改变我们与 AI 技术的交互和利用方式。本仓库旨在引导你完成开发旅程，从基础的 Agent 实现到先进的尖端系统。

<div align="center">
<table>
<tr>
<td>
<h3>📚 学习构建你的第一个 AI Agent</h3>
...
<p>这篇详细的博文与仓库相辅相成，提供了完整的 A-Z 逐步指南，深入解释了核心概念、分步实现过程以及 AI Agent 背后的理论。它设计得极其易于跟随，同时涵盖构建第一个可运行 Agent 所需的所有知识。</p>
<p><em>💡 额外福利：订阅 Newsletter 以抢先获取教程内容，并享受即将推出的课程和书籍的专属折扣！</em></p>
</td>
</tr>
</table>
</div>
...
我们的目标是为所有人提供有价值的资源——无论是刚踏入 AI 领域的新手，还是致力于突破技术边界的资深从业者。通过提供从基础到复杂的各类示例，我们旨在促进 GenAI Agent 这一快速演进领域的学习、实验与创新。

此外，本仓库也是展示创新 Agent 作品的平台。无论你是开发了新颖的 Agent 架构，还是找到了现有技术的创新应用方式，我们都鼓励你将作品分享给社区。

## Related Projects（相关项目）

🚀 通过我的 **[Agents Towards Production](https://github.com/NirDiamant/agents-towards-production)** 仓库实现进阶。它提供横向、代码优先的教程，涵盖构建生产级 GenAI Agent 生命周期中的每个工具与步骤，从概念验证到规模化落地，为你提供经过验证的模式和可复用蓝图。如果你认真考虑将 Agent 推向生产环境，这里是最佳起点。

📚 深入我的 **[RAG Techniques 综合指南](https://github.com/NirDiamant/RAG_Techniques)**，学习如何将外部知识集成到 AI 系统中，通过检索最新且相关的信息来增强其能力。

🖋️ 探索我的 **[Prompt Engineering Techniques 指南](https://github.com/NirDiamant/Prompt_Engineering)**，获取从基础概念到高级方法的提示策略集合，提升你与 AI 语言模型高效沟通的能力。


🧠 为你的 Agent 赋予记忆能力：**[Agent Memory Techniques](https://github.com/NirDiamant/Agent_Memory_Techniques)** — 30 个可运行的 Notebook，涵盖对话缓冲区、向量存储、知识图谱、情景与语义记忆，以及 Mem0、MemGPT/Letta、Zep 和 Graphiti。

## A Community-Driven Knowledge Hub（社区驱动的知识枢纽）

**本仓库因你的贡献而日益强大！** 加入我们的活跃社区——这里是共同塑造并推进该项目的主要阵地 🤝

**[Educational AI Subreddit](https://www.reddit.com/r/EducationalAI/)**

**[GenAI Agents Discord Community](https://discord.gg/cA6Aa4uyDX)**

无论你是渴望学习的新手，还是准备分享知识的专家，你的见解都能塑造 GenAI Agent 的未来。加入我们，提出想法、获取反馈并协作开发创新实现方案。贡献指南请参阅 **[CONTRIBUTING.md](https://github.com/NirDiamant/GenAI_Agents/blob/main/CONTRIBUTING.md)** 文件。让我们共同推进 GenAI Agent 技术！

🔗 如需讨论 GenAI、Agent，或探索知识共享机会，欢迎随时 **[在 LinkedIn 上连接](https://www.linkedin.com/in/nir-diamant-759323134/)**。

## Key Features（核心特性）

- 🎓 学习从入门到进阶构建 GenAI Agent
- 🧠 探索广泛的 Agent 架构与应用场景
- 📚 逐步教程与全面文档
- 🛠️ 实用、开箱即用的 Agent 实现
- 🌟 定期更新 GenAI 最新进展
...
## GenAI Agent Implementations（Agent 实现）

以下是我们 GenAI Agent 实现的综合概览，按分类和功能组织。每个实现都旨在展示 AI Agent 开发的不同方面，从基础对话 Agent 到复杂的多 Agent 系统。
...
### 🌱 Beginner-Friendly Agents（入门级 Agent）
...
1. **Simple Conversational Agent**
   ...
   - **[PydanticAI](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/simple_conversational_agent-pydanticai.ipynb)**
    ...
    #### Overview 🔎（概述）
    具备上下文感知能力的对话 AI，可在多次交互中保持信息状态，从而实现更自然的对话。

    #### Implementation 🛠️（实现方式）
    集成语言模型、Prompt 模板与历史管理器，以生成上下文相关的回复并跟踪会话记录。
...
2. **[Simple Question Answering Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/simple_question_answering_agent.ipynb)**
   ...
   #### Overview 🔎（概述）
   基于 LangChain 和 OpenAI 语言模型的问答（QA）Agent，理解用户查询并提供相关、简洁的答案。
   #### Implementation 🛠️（实现方式）
   结合 OpenAI GPT 模型、Prompt 模板与 LLMChain，以流式处理用户问题并生成 AI 驱动的回复。
...
3. **Simple Data Analysis Agent**
   ...
   #### Overview 🔎（概述）
   基于 AI 的数据分析 Agent，使用自然语言解释数据集并回答问题，将语言模型与数据操作工具结合，实现直观的数据探索。
   #### Implementation 🛠️（实现方式）
   集成语言模型、数据处理框架与 Agent 框架，处理自然语言查询并在合成数据集上执行数据分析，为非技术用户降低洞察获取门槛。

### 🔧 Framework Tutorial（框架教程）
...
4. **[Introduction to LangGraph: Building Modular AI Workflows](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/langgraph-tutorial.ipynb)**
   ...
   #### Overview 🔎（概述）
   本教程介绍 LangGraph，这是一个用于创建模块化、基于图的 AI 工作流的强大框架。学习如何利用 LangGraph 构建更复杂且灵活的 AI Agent，以高效处理多步骤流程。

   #### Implementation 🛠️（实现方式）
   逐步指南演示如何使用 LangGraph 创建 StateGraph 工作流。教程涵盖状态管理、节点创建和图编译等核心概念。通过构建一个简单的文本分析管道来展示这些原则，为更高级的 Agent 架构奠定基础。
...
5. **[Model Context Protocol (MCP):  Seamless Integration of AI and External Resources](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/mcp-tutorial.ipynb)**
   ...
   #### Overview 🔎（概述）
   本教程介绍模型上下文协议（MCP），这是一个用于连接 AI 模型与外部数据源和工具的开放标准。学习 MCP 如何作为 GenAI Agent 与更广泛数字生态系统之间的通用桥梁，实现功能更强、上下文感知能力更高的 AI 应用。

   #### Implementation 🛠️（实现方式）
   提供实操指南，演示如何实现 MCP Server 和 Client，展示如何将语言模型与外部工具和数据源连接。教程涵盖服务器设置、工具定义以及与 AI Client 的集成，并通过实际示例展示如何通过该协议构建实用的 Agent 能力。
...
### 🎓 Educational and Research Agents（教育与科研 Agent）
...
6. **[ATLAS: Academic Task and Learning Agent System](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/Academic_Task_Learning_Agent_LangGraph.ipynb)**
   ...
   #### Overview 🔎（概述）
   ATLAS 展示了如何构建一个智能多 Agent 系统，通过 AI 辅助变革学术支持。该系统利用 LangGraph 的工作流框架协调多个专业 Agent，提供个性化学习计划、笔记记录和顾问支持。

   #### Implementation 🛠️（实现方式）
   使用状态管理的多 Agent 架构，包含四个专业 Agent（Coordinator、Planner、Notewriter、Advisor），通过 LangGraph 工作流框架协同工作。系统具备复杂的档案分析与学术支持工作流，并根据学生表现和反馈进行持续自适应调整。
...
7. **[Scientific Paper Agent - Literature Review](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/scientific_paper_agent_langgraph.ipynb)**
   ...
   #### Overview 🔎（概述）
   一个智能研究助手，通过编排工作流帮助用户导航、理解和分析科学文献。该系统结合学术 API 与高级论文处理技术，自动化文献综述任务，使研究人员能够高效提取学术论文中的洞察，同时保持研究的严谨性与质量控制。

   #### Implementation 🛠️（实现方式）
   利用 LangGraph 创建包含五个节点的工作流系统，涵盖决策、规划、工具执行和质量验证节点。系统集成 CORE API 用于论文访问、PDFplumber 用于文档处理，以及高级语言模型进行分析。关键特性包括用于稳健论文下载的重试机制、通过 Pydantic 模型实现的结构化数据处理，以及带有“人在回路”验证选项的质量导向改进循环。
...
8. **[Chiron - A Feynman-Enhanced Learning Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/chiron_learning_agent_langgraph.ipynb)**
   ...
   #### Overview 🔎（概述）
   一个自适应学习 Agent，通过结构化的检查点系统和费曼式教学法引导用户学习教育内容。系统处理学习材料（用户提供或网络检索），通过交互式检查点验证理解程度，并在需要时提供简化解释，打造模拟一对一辅导的个性化学习体验。

   #### Implementation 🛠️（实现方式）
   使用 LangGraph 编排包含检查点定义、上下文构建、理解验证和费曼教学节点的学习工作流。系统集成网络搜索以动态检索内容，采用语义分块处理上下文，并管理嵌入向量以检索相关信息。关键特性包括 70% 的理解阈值用于进度推进、“人在回路”交互式验证，以及通过 Pydantic 模型实现的结构化输出以确保一致的数据处理。

    #### Additional Resources 📚（附加资源）
    - **[YouTube Explanation](https://www.youtube.com/watch?v=qsdiTGkB8mk)** 

### 💼 Business and Professional Agents（商业与专业 Agent）
...
9. **[Customer Support Agent (LangGraph)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/customer_support_agent_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph 的智能客服 Agent，对查询进行分类、分析情感并提供适当回复或升级处理问题。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 创建工作流，结合状态管理、查询分类、情感分析和回复生成。
...
10. **[Essay Grading Agent (LangGraph)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/essay_grading_system_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph 和 LLM 模型的自动化论文评分系统，根据相关性、语法、结构和深度分析等标准评估论文。

    #### Implementation 🛠️（实现方式）
    利用状态图定义评分工作流，为每个标准集成独立的评分函数。
...
11. **[Travel Planning Agent (LangGraph)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/simple_travel_planner_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph 的旅行规划器，演示如何构建有状态、多步对话式 AI 应用，收集用户输入并生成个性化行程。

    #### Implementation 🛠️（实现方式）
    利用 StateGraph 定义应用流程，集成自定义 PlannerState 进行进程管理。
...
12. **[GenAI Career Assistant Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/agent_hackathon_genAI_career_assistant.ipynb)**
    ...
    #### Overview 🔎（概述）
    GenAI 职业助手演示了如何构建多 Agent 系统，为生成式 AI 领域的职业生涯提供个性化指导。结合 LangGraph 与 Gemini LLM，系统提供定制化学习路径、简历辅助、面试准备和求职支持。

    #### Implementation 🛠️（实现方式）
    利用基于 LangGraph 的多 Agent 架构协调专业 Agent（Learning、Resume、Interview、Job Search），通过 TypedDict 进行状态管理。系统采用复杂的查询分类与路由机制，并集成 DuckDuckGo 等外部工具用于求职和动态内容生成。
...
13. **[Project Manager Assistant Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/project_manager_assistant_agent.ipynb)**
    ...
    #### Overview 🔎（概述）
    专为项目管理任务设计的 AI Agent，自动化从项目描述创建可执行任务、识别依赖关系、安排工作流以及根据专长分配任务给团队成员的过程。系统包含风险评估与自我反思能力，通过多次迭代优化项目计划，旨在最小化整体项目风险。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排专业节点的工作流，包括任务生成、依赖映射、调度、分配和风险评估。每个节点使用 GPT-4o-mini 按照 Pydantic 模型生成结构化输出。系统实现了自我改进反馈循环，风险分数触发反思周期以生成优化项目计划的洞察。可视化工具展示跨迭代生成的甘特图。
...
14. **[Contract Analysis Assistant (ClauseAI)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/ClauseAI.ipynb)**
    ...
    #### Overview 🔎（概述）
    ClauseAI 演示了如何基于多 Agent 方法构建 AI 驱动的合约分析系统。该系统采用专业 AI Agent 处理合同审查的不同方面，从条款分析到合规检查，并利用 LangGraph 进行工作流编排，使用 Pinecone 实现高效的条款检索与对比。

    #### Implementation 🛠️（实现方式）
    基于 LangGraph 实现复杂的状态驱动工作流，协调多个 AI Agent 完成合约分析阶段。系统采用 Pydantic 模型进行数据验证、Pinecone 向量存储用于条款对比，以及 LLM 驱动的生成全面合同报告的分析功能。实现包含并行处理能力，并支持根据用户需求自定义报告生成。
...
15. **[E2E Testing Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/e2e_testing_agent.ipynb)**
    ...
    #### Overview 🔎（概述）
    E2E 测试 Agent 演示了如何构建 AI 驱动的系统，将自然语言测试指令转换为可执行的全栈 Web 测试。利用 LangGraph 进行工作流编排和 Playwright 进行浏览器自动化，使用户能够用纯英语指定测试用例，同时系统处理测试生成与执行的复杂性。

    #### Implementation 🛠️（实现方式）
    基于 LangGraph 实现结构化工作流以协调测试生成、验证和执行。系统采用 TypedDict 状态管理、集成 Playwright 进行浏览器自动化，以及 LLM 驱动的代码生成将自然语言指令转换为可执行测试脚本。实现包含 DOM 状态分析、错误处理和全面的测试报告功能。

    #### Additional Resources 📚（附加资源）
    - **[YouTube Explanation](https://www.youtube.com/watch?v=jPXtpzcCtyA)** 

### 🎨 Creative and Content Generation Agents（创意与内容生成 Agent）
...
16. **[GIF Animation Generator Agent (LangGraph)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/gif_animation_generator_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    一个 GIF 动画生成器，集成 LangGraph 进行工作流管理、GPT-4 用于文本生成和 DALL-E 用于图像创建，根据用户提示词生成自定义动画。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排工作流，使用 GPT-4 生成角色描述、情节和图像提示词，通过 DALL-E 3 创建图像，并使用 PIL 组装为 GIF。采用异步编程以实现高效的并行处理。
...
17. **[TTS Poem Generator Agent (LangGraph)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/tts_poem_generator_agent_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph 和 OpenAI API 的高级文本转语音（TTS）Agent，对输入文本进行分类，根据内容类型进行处理并生成相应的语音输出。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排工作流，使用 GPT 模型对输入文本分类，应用特定内容的处理逻辑，并通过 OpenAI TTS API 将处理后的文本转换为语音。系统会根据识别出的内容类型（通用、诗歌、新闻或笑话）自适应调整输出。
...
18. **[Music Compositor Agent (LangGraph)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/music_compositor_agent_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph 和 OpenAI 语言模型的 AI 音乐作曲家，根据用户输入生成自定义音乐作品。系统通过专业组件处理输入，各部分共同贡献于最终乐曲，随后转换为可播放的 MIDI 文件。

    #### Implementation 🛠️（实现方式）
    LangGraph 编排工作流将用户输入转化为音乐创作，使用 ChatOpenAI (GPT-4) 生成旋律、和声与节奏，并进行风格适配。最终的 AI 生成作品通过 music21 转换为 MIDI 文件，并可使用 pygame 进行回放。
...
19. **[Content Intelligence: Multi-Platform Content Generation Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/ContentIntelligence.ipynb)**
    ...
    #### Overview 🔎（概述）
    Content Intelligence 演示了如何构建高级内容生成系统，将输入文本转化为跨多个社交媒体渠道的平台优化内容。系统利用 LangGraph 进行工作流编排以分析内容、进行研究并生成定制化内容，同时保持跨不同平台的品牌一致性。

    #### Implementation 🛠️（实现方式）
    基于 LangGraph 实现复杂工作流，协调多个专业节点（摘要、研究、平台特定）完成内容生成过程。系统采用 TypedDict 和 Pydantic 模型进行状态管理，集成 Tavily Search 增强研究能力，并使用 GPT-4 进行平台特定内容生成。实现包含多平台并行处理和可自定义的内容模板。
...
20. **[Business Meme Generator Using LangGraph and Memegen.link](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/business_meme_generator.ipynb)**
    ...
    #### Overview 🔎（概述）
    商业梗图生成器演示了如何构建 AI 驱动的系统，基于公司网站分析生成上下文相关的梗图。利用 LangGraph 进行工作流编排，系统结合 Groq 的 Llama 模型用于文本分析和 Memegen.link API，自动为数字营销生产品牌对齐的梗图。

    #### Implementation 🛠️（实现方式）
    基于 LangGraph 实现状态管理工作流以协调网站内容分析、梗图概念生成和图像创建。系统采用 Pydantic 模型进行数据验证、使用 aiohttp 进行异步处理，并集成外部 API（Groq、Memegen.link）构建完整的梗图生成管道，支持自定义模板。
...
21. **[Murder Mystery Game with LLM Agents](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/murder_mystery_agent_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）  
    一款基于文本的侦探游戏，利用自主 LLM Agent 作为交互式角色参与程序化生成的谋杀谜案。受 UNBOUNDED 论文启发，系统每次生成独特场景，玩家扮演夏洛克·福尔摩斯的角色，通过角色访谈和演绎推理破案。

    #### Implementation 🛠️（实现方式）
    利用两个 LangGraph 工作流——主游戏循环用于故事/角色生成和游戏进度推进，对话子图用于角色交互。系统结合 LLM 驱动的叙事生成、角色 AI 和结构化游戏规则，打造沉浸式调查体验与可重玩剧情。

     #### Additional Resources 📚（附加资源）
    - **[YouTube Explanation](https://www.youtube.com/watch?v=_3cJYlk2EmA)**


### 📊 Analysis and Information Processing Agents（分析与信息处理 Agent）
...
22. **[Memory-Enhanced Conversational Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/memory_enhanced_conversational_agent.ipynb)**
    ...
    #### Overview 🔎（概述）
    具备记忆增强的对话 AI Agent，集成短期和长期记忆系统以在会话内及跨多次会话保持上下文，提升交互质量与个性化体验。

    #### Implementation 🛠️（实现方式）
    将语言模型与独立的短/长时记忆存储结合，使用整合两种记忆的 Prompt 模板，并采用内存管理器进行存储与检索。系统包含交互循环，在每次回复前更新并利用记忆内容。
...
23. **[Multi-Agent Collaboration System](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/multi_agent_collaboration_system.ipynb)**
    ...
    #### Overview 🔎（概述）
    结合历史研究与数据分析的多 Agent 协作系统，利用大语言模型模拟专业 Agent 协同工作以回答复杂的历史问题。

    #### Implementation 🛠️（实现方式）
    基于基础 Agent 类创建专业的 HistoryResearchAgent 和 DataAnalysisAgent，由 HistoryDataCollaborationSystem 编排。系统遵循五步流程：历史背景提供、数据需求识别、历史数据提供、数据分析与最终综合。
...
24. **[Self-Improving Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/self_improving_agent.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangChain 的自我改进 Agent，在对话中互动、从交互中学习，并通过反思与自适应持续提升性能。

    #### Implementation 🛠️（实现方式）
    集成语言模型、聊天历史管理、回复生成和反思机制。系统采用学习模块整合反思洞察以增强未来表现，形成持续改进循环。

25. **[Task-Oriented Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/task_oriented_agent.ipynb)**
    
    #### Overview 🔎（概述）
    基于 LangChain 的语言模型应用，用于文本摘要和将摘要翻译为西班牙语，结合自定义函数、结构化工具和 Agent 实现高效文本处理。

    #### Implementation 🛠️（实现方式）
    使用自定义函数进行摘要与翻译并包装为结构化工具。采用 Prompt 模板引导 Agent 协调工具使用。Agent Executor 管理流程，接收输入文本并输出英文摘要及其西班牙语翻译。
...
26. **[Internet Search and Summarize Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/search_the_internet_and_summarize.ipynb)**
    ...
    #### Overview 🔎（概述）
    智能网络研究助手，结合网页搜索能力与 AI 驱动的摘要功能，自动化从互联网收集信息并提炼为简洁、相关摘要的过程。

    #### Implementation 🛠️（实现方式）
    集成基于 DuckDuckGo API 的网页搜索模块、结果解析器和利用 OpenAI 语言模型的文本摘要引擎。系统执行站点特定或通用搜索，提取相关内容，生成简洁摘要，并编译带引用的结果以实现高效信息检索与综合。
...
27. **[Multi agent research team - Autogen](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/research_team_autogen.ipynb)**
    ...
    #### Overview 🔎（概述）
    本方案探索基于 AutoGen 库的多 Agent 协作研究系统。利用 Agent 协同完成任务，注重高效执行与质量保证。系统通过将任务分配给专业 Agent 来增强研究能力。

    #### Implementation 🛠️（实现方式）
    使用 GPT-4 模型为 Agent 配置特定角色，包括 Admin、Developer、Planner、Executor 和 QA。交互管理确保有序通信与明确的状态转换。任务执行涉及协作规划、编码、执行和质量检查，展示了适用于各领域的可扩展框架。

    #### Additional Resources 📚（附加资源）
    - **[comprehensive solution with UI](https://github.com/yaninvak/dream-team)** 
...
28. **[Sales Call Analyzer](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/sales_call_analyzer_agent.ipynb)**
    ...
    #### Overview 🔎（概述）
    智能系统，通过结合音频转录与高级自然语言处理自动化销售通话录音分析。分析器使用 OpenAI Whisper 进行音频转录，利用 NLP 技术处理文本，并生成包含情感分析、关键短语、痛点和可操作建议的综合报告，以改善销售业绩。

    #### Implementation 🛠️（实现方式）
    在结构化工作流中集成多个组件：OpenAI Whisper 用于音频转录、CrewAI 用于任务自动化与 Agent 管理、LangChain 用于编排分析管道。系统按步骤处理音频，从转录到详细分析，利用自定义 Agent 和任务生成包含客户情感、销售机会和改进建议的结构化 JSON 报告。
...
29. **[Weather Emergency & Response System](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/Weather_Disaster_Management_AI_AGENT.ipynb)**
    ...
    #### Overview 🔎（概述）
    综合系统演示了两种 Agent 图实现用于天气应急响应：实时图处理真实天气数据，混合图结合真实与模拟数据以测试高严重性场景。系统处理从数据采集到应急计划生成的完整工作流，包含自动化通知和人工验证步骤。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排复杂工作流并进行状态管理，集成 OpenWeatherMap API 获取实时数据，使用 Gemini 进行分析与回复生成。系统包含邮件通知、社交媒体监控模拟以及基于严重程度的路由机制，低/中严重程度事件支持可配置的人工验证。
...
30. **[Self-Healing Codebase System](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/self_healing_code.ipynb)**
    ...
    #### Overview 🔎（概述）
    智能系统，利用 LangGraph 工作流编排和 ChromaDB 向量存储自动检测、诊断并修复运行时代码错误。系统通过向量嵌入维护遇到过的 Bug 及其修复方案记忆，实现跨代码库的相似错误模式识别。

    #### Implementation 🛠️（实现方式）
    基于状态的图工作流处理函数定义与运行时参数，通过专业节点进行错误检测、代码分析和修复生成。集成 ChromaDB 用于向量存储 Bug 模式和修复方案，具备自动搜索和检索相似错误模式的能力，同时通过结构化验证步骤保障代码执行安全。
...
31. **[DataScribe: AI-Powered Schema Explorer](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/database_discovery_fleet.ipynb)**
    ...
    #### Overview 🔎（概述）
    智能 Agent 系统，通过自然语言交互实现关系数据库的直观探索与查询。系统利用专业 Agent 舰队，由有状态的 Supervisor 协调，处理模式发现、查询规划与数据分析任务，同时通过基于向量的关系图保持上下文理解。
    
    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排多 Agent 工作流（包括 Discovery、Inference 和 Planning Agent），使用 NetworkX 进行关系图的可视化与管理。系统通过 TypedDict 类实现动态状态管理，使用 db_graph 属性在会话间维护数据库上下文，并包含防止未经授权修改数据库的安全措施。
...
32. **[Memory-Enhanced Email Agent (LangGraph & LangMem)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/memory-agent-tutorial.ipynb)**
    ...
    #### Overview 🔎（概述）
    智能邮件助手，结合三种类型的记忆（语义、情景和程序性）构建随时间推移不断优化的系统。Agent 可对收件箱进行分类，使用存储的知识起草上下文相关的回复，并根据用户反馈提升性能。
    
    #### Implementation 🛠️（实现方式）
    利用 LangGraph 进行工作流编排和 LangMem 进行多类型记忆的高级管理。系统实现了带记忆增强决策的分类工作流、用于邮件撰写和日历管理的专用工具，以及基于反馈和历史性能的自我改进机制以更新自身 Prompt。
...
### 📰 News and Information Agents（新闻与信息 Agent）
...
33. **[News TL;DR using LangGraph](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/news_tldr_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于用户查询生成当前事件简洁 TL;DR 摘要的新闻系统。利用大语言模型进行决策与摘要，并集成新闻 API 获取最新内容，使用户能够通过生成的要点摘要快速了解感兴趣的话题。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排结合多个组件的工作流：GPT-4o-mini 用于生成搜索词和文章摘要、NewsAPI 检索文章元数据、BeautifulSoup 进行网页抓取、Asyncio 处理并发请求。系统遵循从查询处理到文章选择与摘要的结构化管道，管理各组件间的流程以生成相关新闻文章的 TL;DR。
...
34. **[AInsight: AI/ML Weekly News Reporter](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/ainsight_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    AInsight 演示了如何基于多 Agent 架构构建智能新闻聚合与摘要系统。系统采用三个专业 Agent（NewsSearcher、Summarizer、Publisher），通过 LangGraph 工作流编排自动收集、处理和总结面向大众读者的 AI/ML 新闻。

    #### Implementation 🛠️（实现方式）
    基于 LangGraph 实现状态管理的多 Agent 系统，协调新闻采集（Tavily API）、技术内容摘要（GPT-4）和报告生成流程。系统采用模块化架构、TypedDict 状态管理、外部 API 集成以及可自定义模板的 Markdown 报告生成。
...
35. **[Journalism-Focused AI Assistant](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/journalism_focused_ai_assistant_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    专为记者打造的 AI 助手，帮助应对虚假信息、偏见和信息过载等现代新闻挑战。系统集成事实核查、语气分析、摘要和语法审查工具，在保持道德报道标准的同时提升新闻工作的准确性与效率。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排专业组件工作流，包括用于分析与生成的语言模型、通过 DuckDuckGo API 集成的网络搜索、PyMuPDFLoader 和 WebBaseLoader 等文档解析工具、RecursiveCharacterTextSplitter 文本分块以及结构化 JSON 输出。各组件在统一工作流中协同运作，分析内容、验证事实、检测偏见、提取引语并生成综合报告。
...
36. **[Blog Writer (Open AI Swarm)](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/blog_writer_swarm.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 OpenAI Swarm 包的多 Agent 协作博客文章创作系统。利用专业 Agent 高效执行研究、规划、撰写和编辑任务。

    #### Implementation 🛠️（实现方式）
    使用 OpenAI Swarm Package 管理 Agent 交互。包含 Admin、Researcher、Planner、Writer 和 Editor，各有明确职责。系统遵循结构化工作流：主题设定、大纲制定、研究、起草与编辑。该方法通过任务分配、专业化和协作解决问题提升内容创作质量。
...
37. **[Podcast Internet Search and Generate Agent 🎙️](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/generate_podcast_agent_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    两步式 Agent：首先搜索给定主题的相关信息，然后基于搜索结果生成播客。第一步使用搜索 Agent 和函数查找最相关信息；第二步使用播客生成 Agent 和函数创建播客内容。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排两步工作流。第一步涉及搜索 Agent 与函数从互联网收集信息；第二步使用播客生成 Agent 与函数基于收集的信息创建播客。


### 🛍️ Shopping and Product Analysis Agents（购物与产品分析 Agent）
...
38. **[ShopGenie - Redefining Online Shopping Customer Experience](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/ShopGenie.ipynb)**
    ...
    #### Overview 🔎（概述）
    AI 驱动的购物助手，帮助客户在缺乏领域专业知识的情况下做出明智的购买决策。系统分析多源产品信息、对比规格与评价、根据用户需求识别最佳选项，并通过邮件发送推荐及支持性视频评测，打造综合购物体验。

    #### Implementation 🛠️（实现方式）
    使用 LangGraph 编排工作流，结合 Tavily 进行网络搜索、Llama-3.1-70B 进行结构化数据分析与产品对比，以及 YouTube API 检索评测视频。系统通过多个节点处理搜索结果，包括模式映射、产品对比、评论识别和邮件生成。关键特性包括用于一致数据处理的 Pydantic 模型、稳健 API 交互的重试机制，以及通过 SMTP 发送邮件分享推荐。
...
39. **[Car Buyer AI Agent](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/car_buyer_agent_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    智能产品购买 AI Agent 演示了如何构建辅助用户做出明智购买决策的系统。利用 LangGraph 与 LLM 驱动的智能，系统处理用户需求、从 AutoTrader 等网站抓取产品列表，并提供详细的分析与购车推荐。

    #### Implementation 🛠️（实现方式）
    基于 LangGraph 实现状态管理工作流以协调用户交互、网络抓取和决策支持。系统采用 TypedDict 状态管理、使用 Playwright 进行异步网页抓取，并集成外部 API 进行全面的产品分析。实现包含用于实时聊天交互的 Gradio 界面以及易于扩展至其他产品类别的模块化爬虫架构。

     #### Additional Resources 📚（附加资源）
    - **[YouTube Explanation](https://www.youtube.com/watch?v=I61I1fp0qys)**

### 🎯 Task Management and Productivity Agents（任务管理与生产力 Agent）
...
40. **[Taskifier - Intelligent Task Allocation & Management](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/taskifier.ipynb)**
    ...
    #### Overview 🔎（概述）
    智能任务管理系统，分析用户工作风格并创建个性化任务分解策略。该系统源于对学生和职场新人因任务模糊导致拖延的观察。系统评估历史工作模式，通过网页搜索收集相关任务信息，生成定制化分步方案以优化生产力并减少工作流程瘫痪。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排多步工作流，包括工作风格分析、通过 Tavily API 收集信息和定制计划生成。系统在过程中维护状态，将历史工作模式数据与最新任务研究相结合，输出与用户自然工作方式对齐的详细个性化任务执行计划。
...
41. **[Grocery Management Agents System](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/grocery_management_agents_system.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 CrewAI 构建的多 Agent 系统，自动化杂货管理任务，包括收据解析、保质期跟踪、库存管理和食谱推荐。系统使用专业 Agent 提取收据数据、估算产品货架寿命、跟踪消耗情况并建议食谱以减少食物浪费。

    #### Implementation 🛠️（实现方式）
    基于 CrewAI 实现四个专业 Agent：Receipt Interpreter 提取收据商品详情、Expiration Date Estimator 利用在线资源确定保质期、Grocery Tracker 根据消耗维持库存、Recipe Recommender 使用可用食材建议餐食。每个 Agent 拥有特定工具与任务，通过 Crew 工作流进行编排。

     #### Additional Resources 📚（附加资源）
    - **[YouTube Explanation](https://www.youtube.com/watch?v=FlMu5pKSaHI)**

### 🔍 Quality Assurance and Testing Agents（质量保证与测试 Agent）
...
42. **[LangGraph-Based Systems Inspector](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/graph_inspector_system_langgraph.ipynb)**
    ...
    #### Overview 🔎（概述）
    针对 LangGraph 应用的全面测试与验证工具，自动分析系统架构、生成测试用例并通过多 Agent 检查识别潜在漏洞。Inspector 采用专业 AI 测试员评估系统的不同方面，从基础功能到安全问题和边缘情况。

    #### Implementation 🛠️（实现方式）
    集成 LangGraph 进行工作流编排、多个 LLM 驱动的测试 Agent 以及结构化评估管道，包括静态分析、测试用例生成和结果验证。系统使用 Pydantic 进行数据验证、NetworkX 进行图表示，并采用模块化架构支持并行测试执行与全面结果分析。
...
43. **[EU Green Deal FAQ Bot](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/EU_Green_Compliance_FAQ_Bot.ipynb)**
    ...
    #### Overview 🔎（概述） 
    EU Green Deal FAQ Bot 演示了如何构建基于 RAG 的 AI Agent，帮助企业理解欧盟绿色协议政策。系统将复杂的监管文档处理为可管理块，并提供关于环境合规、排放报告和废物管理要求的即时准确答案。

    #### Implementation 🛠️（实现方式） 
    基于 FAISS 向量存储和语义分块预处理构建高级 RAG 管道，并使用多个专业 Agent（Retriever、Summarizer、Evaluator）处理查询。系统包含用于提升准确性的查询改写功能、通过黄金问答数据集进行交叉验证的机制，以及全面的评估指标以确保回复质量与相关性。
...
44. **[Systematic Review Automation System + Paper Draft Creation](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/systematic_review_of_scientific_articles.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于有向图架构和 LangChain 组件的综合系统，用于自动化学术系统综述。该系统生成完整、可直接发表的学术论文，自动处理从文献搜索到最终草稿生成的全过程，包含多次修订周期。

    #### Implementation 🛠️（实现方式）
    利用基于状态图的流程处理论文搜索与筛选（最多 3 篇）、PDF 处理，并生成包含所有标准章节（摘要、引言、方法、结果、结论、参考文献）的完整学术论文。系统整合多次修订周期，包含自动批评与改进阶段，全部通过 LangGraph 状态管理进行编排。
...
46. **[HR AI Assistant](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/HR_AI-Assistant.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph 工作流的 AI 招聘助手，涵盖需求收集、职位描述生成、LinkedIn 候选人搜索和简历分析。

    #### Implementation 🛠️（实现方式）
    利用 LangChain 和 LangGraph 编排多步招聘管道，采用结构化状态管理、OpenAI 进行语言生成以及自动化候选人评估工作流。
...
47. **[AI-Driven ML and Data Science Assistant](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/ai_driven_ml_and_datascience_assistant.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph + OpenAI 的综合机器学习助手，通过 Agent 工作流加载数据集、执行预处理、特征工程、模型训练、评估与可视化。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph 编排 ML 管道工具，包括数据预处理、模型选择、超参数调优和结果可视化。演示了端到端的 Agentic ML 工作流并集成 Kaggle 数据集。

48. **[Art Tourguide with LightRAG](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/art_agent.ipynb)**

    #### Overview 🔎（概述）
    基于 LightRAG（知识图谱 RAG）和 LangGraph 的交互式艺术导览，通过结构化数据检索实现对话式艺术馆藏探索。

    #### Implementation 🛠️（实现方式）
    结合 LightRAG 进行基于知识图谱的检索、LangGraph Agent 链、交互式 Widget UI 以及自定义艺术数据处理。展示了图 RAG 在创意领域的新颖应用。
...
49. **[Project Gutenberg Conversational Helper](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/Gutenbergs_Sage.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 Ollama 本地 LLM 探索 Project Gutenberg 文本的对话 Agent，通过 Chroma/Pinecone 实现向量存储 RAG，并使用 spaCy 进行命名实体识别。

    #### Implementation 🛠️（实现方式）
    利用 LangGraph + Ollama 实现完全本地的 LLM 推理、多用户支持与会话管理、NER 增强检索以及双向量存储集成（Chroma 用于本地，Pinecone 用于云端）。
...
50. **[Contextual Quoting Agentic System](https://github.com/NirDiamant/GenAI_Agents/blob/main/all_agents_tutorials/contextual_quoting_agentic_system.ipynb)**
    ...
    #### Overview 🔎（概述）
    基于 LangGraph 与 RAG 的复杂多 Agent 系统，用于保险/商业报价，包含检索、推理、分类和报价生成的专业 Agent。

    #### Implementation 🛠️（实现方式）
    采用 ChromaDB 进行 RAG、SQLite 存储结构化数据、Pydantic 模式进行验证，以及使用 OpenAI + Groq 协调工作流的专业 Agent（检索器、推理器、分类器、报价生成器）。这是本集合中最贴近生产的多 Agent 实现之一。

> 📖 **想了解驱动这些 Agent 的 RAG 技术？** [RAG Made Simple](https://europe-west1-rag-techniques-views-tracker.cloudfunctions.net/rag-techniques-tracker?notebook=genai-agents--readme-book-cta&click=book-buy-amazon-readme-cta&target=https%3A%2F%2Fwww.amazon.com%2Fdp%2FB0D76734SZ%3Ftag%3Ddiamantai-genai-20&text=RAG%20Made%20Simple) 以可视化方式覆盖 22 种 RAG 技术。Kindle Unlimited 免费阅读。

### 🌟 Special Advanced Technique 🌟（特殊高级技术）

45. **[Sophisticated Controllable Agent for Complex RAG Tasks 🤖](https://github.com/NirDiamant/Controllable-RAG-Agent)**

    #### Overview 🔎（概述）
    专为解决简单基于语义相似度的检索无法处理的复杂问题而设计的高级 RAG 方案。该方法使用复杂的确定性图作为高度可控自主 Agent 的“大脑”🧠，能够回答来自你自有数据中的非平凡问题。

    #### Implementation 🛠️（实现方式）
    • 实施多步流程，包括问题匿名化、高层规划、任务分解、自适应信息检索与问答、持续重新规划以及严格的答案验证，以确保回复有据可依且准确无误。
...
## 💼 Apply for open AI engineering jobs（申请开放的 AI 工程职位）
