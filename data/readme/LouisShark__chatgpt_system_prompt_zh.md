...
本仓库收录了适用于 ChatGPT 及其他 AI 产品和 [自定义 GPT（Custom GPTs）](https://openai.com/blog/introducing-gpts) 的各类系统提示词，对于学习编写系统提示词和创建自定义 GPT 具有重要的参考价值。

<img src="bg.png" width="800px" />

## 快速导航

- [入门指南](./GETTING_STARTED.md) - 了解如何获取系统提示词与知识库文件
- [安全指南](./SECURITY.md) - 学习如何保护你的 GPT 指令
- [贡献指南](./CONTRIBUTING.md) - 如何为本项目做出贡献
- [学习资源](./RESOURCES.md) - 实用工具与学习资料
- [查找系统提示词与自定义 GPT](./TOC.md) - 浏览我们的合集

## 如何在仓库中查找 GPT 的指令与信息

1. 前往 [TOC.md](./TOC.md)
2. 使用 `Ctrl + F` 搜索你想查找的 GPT 名称
3. 如果你已克隆本仓库，可以使用 [`idxtool`](./scripts/README.md) 工具进行检索

## 免责声明

分享这些提示词/指令纯粹出于参考与知识共享的目的，旨在提升大家的提示词编写技巧，并提高对提示词注入（Prompt Injection）安全的意识。

我们注意到，许多 GPT 作者已从中汲取经验并改进了安全措施，学习如何更好地保护自己的作品。这与本项目初衷相符。

## 支持我

如果你觉得这些提示词对你有帮助，请给我一个 **Star**。衷心感谢你的支持 :)
