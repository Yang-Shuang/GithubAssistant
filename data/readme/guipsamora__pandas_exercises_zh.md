...
厌倦了海量的教程却难以找到练习资源，我决定创建一个专门用于 Pandas 练习的仓库。别误会，教程确实是极好的学习资源，但学习的本质在于实践。如果不动手练习，你就无法真正掌握。

本仓库包含三种不同类型的文件：  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. 练习说明（Exercise instructions）  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 仅含答案的解决方案（无代码）  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. 包含代码和注释的完整解决方案  

建议你先通过教程、视频或文档学习某个主题，然后完成对应的练习。接着学习下一个主题并继续练习。如果遇到卡壳的地方，不要直接查看带代码的解决方案文件。可以先查阅仅含答案的文件，尝试自己推导出正确答案。

非常欢迎提出建议和贡献协作。🙂 请提交 Issue 或创建 Pull Request（PR），并注明对应的练习题目以及你的问题/解决方案。

# 课程与练习

|				                                  |				                                   |                   |
|:-----------------------------------------------:|:----------------------------------------------:|:-----------------:|
|[获取与了解](#getting-and-knowing)      | [合并](#merge)                                |[时间序列](#time-series)|
|[过滤与排序](#filtering-and-sorting)  | [统计](#stats)                                |[删除](#deleting)       |
|[分组](#grouping)|							  | [可视化](#visualization)                |[索引处理]           |
|[Apply 操作](#apply)|							      | [创建 Series 和 DataFrame](#creating-series-and-dataframes) 		            |[导出]|

### [获取与了解](https://github.com/guipsamora/pandas_exercises/tree/master/01_Getting_%26_Knowing_Your_Data)  
...
### [过滤与排序](https://github.com/guipsamora/pandas_exercises/tree/master/02_Filtering_%26_Sorting)
...
### [分组](https://github.com/guipsamora/pandas_exercises/tree/master/03_Grouping)
...
### [Apply 操作](https://github.com/guipsamora/pandas_exercises/tree/master/04_Apply)
...
### [合并](https://github.com/guipsamora/pandas_exercises/tree/master/05_Merge)
...
### [统计](https://github.com/guipsamora/pandas_exercises/tree/master/06_Stats)
...
### [可视化](https://github.com/guipsamora/pandas_exercises/tree/master/07_Visualization)
...
### [创建 Series 和 DataFrame](https://github.com/guipsamora/pandas_exercises/tree/master/08_Creating_Series_and_DataFrames)  
- [ ] [Pokemon](https://github.com/guipsamora/pandas_exercises/tree/master/08_Creating_Series_and_DataFrames/Pokemon)  

### [时间序列](https://github.com/guipsamora/pandas_exercises/tree/master/09_Time_Series)  
...
### [删除](https://github.com/guipsamora/pandas_exercises/tree/master/10_Deleting)  
